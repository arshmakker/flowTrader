...
class DataCollector:
    def __init__(self, api, symbol_manager=None):
        ...
        self.index_specs = {
            "NIFTY": {"exchange": "NFO", "symbol_prefix": "NIFTY", "lot_size": 65},
            "BANKNIFTY": {"exchange": "NFO", "symbol_prefix": "BANKNIFTY", "lot_size": 30},
            "FINNIFTY": {"exchange": "NFO", "symbol_prefix": "FINNIFTY", "lot_size": 60},
        }
    ...
    def start_collection(self, symbols=None):
        ...
        self.collection_thread = threading.Thread(target=self._collect_data, args=(symbols,))
    ...
    def _collect_data(self, symbols):
        ...
        while self.collection_active:
            try:
                ...
                counts = {"EQ": 0, "FUTIDX": 0, "FUTSTK": 0, "OPTIDX": 0, "OPTSTK": 0}
    ...
    def _save_raw_data(self, data_point):
        ...
        try:
            ...
            filename = os.path.join(final_dir, f"{data_point['symbol']}_{datetime.now().strftime('%Y%m%d')}.csv")
